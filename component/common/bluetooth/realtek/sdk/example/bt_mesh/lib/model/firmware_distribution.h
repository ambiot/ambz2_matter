...
{
    FW_NODE_PHASE_IDLE,
    FW_NODE_PHASE_UPDATE_STARTING,
    FW_NODE_PHASE_UPDATE_STARTED,
    FW_NODE_PHASE_APPLYING,
    FW_NODE_PHASE_APPLIED,
    FW_NODE_PHASE_CONFIRMED,
    FW_NODE_PHASE_CANCELING,
    FW_NODE_PHASE_FAILED,
} fw_node_phase_t;

typedef struct _fw_dist_update_node_t
{
    struct _fw_dist_update_node_t *pnext;
    fw_update_node_t update_node;
    fw_node_phase_t node_phase;
 ...
 * @param[in] addr: receiver address
 * @return receiver information pointer
 */
fw_dist_update_node_p fw_dist_server_receiver_get_by_addr(uint16_t addr);
 ...
 * @return none
 */
void fw_dist_server_delete_receiver_by_addr(uint16_t addr);
