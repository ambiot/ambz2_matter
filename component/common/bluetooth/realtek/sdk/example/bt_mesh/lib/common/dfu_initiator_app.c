...
int32_t dfu_init_dist_client_data(const mesh_model_info_p pmodel_info, uint32_t type, void *pargs)
{
    ...
    case FW_DIST_CLIENT_RECVS_STATUS:
        {
            // fw_dist_client_recvs_status_t *pdata = (fw_dist_client_recvs_status_t *)pargs;
        }
        break;
    case FW_DIST_CLIENT_RECVS_LIST:
        {
            // fw_dist_client_recvs_list_t *pdata = (fw_dist_client_recvs_list_t *)pargs;
        }
        break;
    case FW_DIST_CLIENT_CAPS_STATUS:
        {
            // fw_dist_client_caps_status_t *pdata = (fw_dist_client_caps_status_t *)pargs;
        }
        break;
    case FW_DIST_CLIENT_STATUS:
        {
            // fw_dist_client_dist_status_t *pdata = (fw_dist_client_dist_status_t *)pargs;
        }
        break;
    ...
    case FW_DIST_CLIENT_FW_STATUS:
        {
            // fw_dist_client_fw_status_t *pdata = (fw_dist_client_fw_status_t *)pargs;
        }
        break;
    default:
        break;
                           ...
                           uint8_t *pfw_metadata, uint8_t metadata_len, uint32_t fw_image_size)
{
    ...
    dfu_init_ctx.upload_fw_image.fw_id.company_id = 0x005d;
    dfu_init_ctx.upload_fw_image.fw_id.version[0] = 0x00;
    dfu_init_ctx.upload_fw_image.fw_id.version[1] = 0x01;
    dfu_init_ctx.upload_fw_image.fw_id_len = 4;
    ...
    fw_dist_upload_start(dst, app_key_index, mesh_node.ttl, update_timeout_base, dfu_init_ctx.blob_id,
                         ...
                         (uint8_t *)&dfu_init_ctx.upload_fw_image.fw_id, dfu_init_ctx.upload_fw_image.fw_id_len);
