                        ...
                        size_t threshold, int strong )
{
    ...
    ctx->source_count++;
    //printf("mbedtls_entropy_add_source ctx->source_count  addr is %x,line is %d------------- cl\r\n",&(ctx->source_count), __LINE__);
...
cleanup:
    ...
    //printf("entropy_gather_internal ret is %d,line is %d --------- cl\r\n",ret,__LINE__);
    return( ret );
}
...
int mbedtls_entropy_func( void *data, unsigned char *output, size_t len )
{
    ...
    //printf("mbedtls_entropy_func ret is %d, line is %d --------- cl\r\n", ret, __LINE__);
