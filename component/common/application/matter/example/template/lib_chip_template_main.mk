...
INCLUDES += -I$(SDKROOTDIR)/component/common/application/matter/example/template
...
# Add source file for your device types
# Add any drivers needed
SRC_CPP += $(SDKROOTDIR)/component/common/application/matter/example/template/example_matter_template.cpp
SRC_CPP += $(SDKROOTDIR)/component/common/application/matter/example/template/matter_drivers.cpp
