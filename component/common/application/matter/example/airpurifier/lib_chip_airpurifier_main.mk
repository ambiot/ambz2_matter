...
SRC_CPP += $(SDKROOTDIR)/component/common/application/matter/example/airpurifier/example_matter_airpurifier.cpp
SRC_CPP += $(SDKROOTDIR)/component/common/application/matter/example/airpurifier/matter_drivers.cpp
