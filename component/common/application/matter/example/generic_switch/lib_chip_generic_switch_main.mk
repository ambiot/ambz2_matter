...
INCLUDES += -I$(SDKROOTDIR)/component/common/application/matter/example/generic_switch
...
SRC_CPP += $(SDKROOTDIR)/component/common/application/matter/driver/matter_switch_cluster/matter_switch_server.cpp
SRC_CPP += $(SDKROOTDIR)/component/common/application/matter/driver/matter_switch_cluster/switch_driver.cpp
SRC_CPP += $(SDKROOTDIR)/component/common/application/matter/example/generic_switch/example_matter_generic_switch.cpp
SRC_CPP += $(SDKROOTDIR)/component/common/application/matter/example/generic_switch/matter_drivers.cpp
