...
OUTPUT_DIR			= $(MATTER_MAKEDIR)/light_logredirect/build/chip
...
SRC_CPP += $(SDKROOTDIR)/component/common/application/matter/driver/ameba_logging_redirect_handler.cpp
SRC_CPP += $(SDKROOTDIR)/component/common/application/matter/example/light_logredirect/example_matter_light_logredirect.cpp
SRC_CPP += $(SDKROOTDIR)/component/common/application/matter/example/light_logredirect/matter_drivers.cpp
...
#CFLAGS += -DCHIP_CONFIG_ERROR_SOURCE_NO_ERROR=0
