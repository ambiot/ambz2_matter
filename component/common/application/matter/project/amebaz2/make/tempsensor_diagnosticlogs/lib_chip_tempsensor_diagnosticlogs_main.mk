...
OUTPUT_DIR			= $(MATTER_MAKEDIR)/tempsensor_diagnosticlogs/build/chip
...
SRC_CPP += $(SDKROOTDIR)/component/common/application/matter/driver/temperature_sensor_driver.cpp
SRC_CPP += $(SDKROOTDIR)/component/common/application/matter/driver/ameba_diagnosticlogs_provider_delegate_impl_fat.cpp
SRC_CPP += $(SDKROOTDIR)/component/common/application/matter/driver/ameba_diagnosticlogs_provider_delegate_impl_nofat.cpp
#SRC_CPP += $(SDKROOTDIR)/component/common/application/matter/driver/ameba_diagnosticlogs_provider_delegate_impl.cpp
#SRC_CPP += $(SDKROOTDIR)/component/common/application/matter/example/tempsensor_diagnosticlogs/ameba_faultlog.cpp
SRC_CPP += $(SDKROOTDIR)/component/common/application/matter/driver/ameba_logging_faultlog.cpp
SRC_CPP += $(SDKROOTDIR)/component/common/application/matter/example/tempsensor_diagnosticlogs/example_matter_tempsensor_diagnosticlogs.cpp
SRC_CPP += $(SDKROOTDIR)/component/common/application/matter/example/tempsensor_diagnosticlogs/matter_drivers.cpp
