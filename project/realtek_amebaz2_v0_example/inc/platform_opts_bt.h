...
/* Please enable only one between CONFIG_BT_MATTER_ADAPTER & CONFIG_BT_MESH_DEVICE_MATTER */
...
#error "Please enable both CONFIG_BT_MESH_DEVICE_MATTER & CONFIG_BT_MESH_DEVICE_MULTIPLE_PROFILE"
	...
	(CONFIG_BT_MATTER_ADAPTER && CONFIG_BT_MESH_DEVICE_MATTER)
#error "Please enable only either one of CONFIG_BT_MATTER_ADAPTER or CONFIG_BT_MESH_DEVICE_MATTER"
#endif
#endif
#endif // CONFIG_BT
