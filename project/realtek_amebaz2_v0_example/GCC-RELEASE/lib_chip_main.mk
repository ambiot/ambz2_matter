...
INCLUDES += -I$(BASEDIR)/../../../component/common/application/matter/common/bluetooth/ms_ble_adapter
...
SRC_CPP += $(CHIPDIR)/src/app/util/ClientMonitoringRegistrationTable.cpp
