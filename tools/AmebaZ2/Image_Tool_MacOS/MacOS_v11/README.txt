...
3. Set Ameba chip
Example:
	- sudo ./Ameba_1-10_MP_ImageTool_MacOS11 -set chip AmebaZ2
...
7. [No need on AmebaZ2] Combine AmebaD three images
...
8. Set image file path
    - sudo ./Ameba_1-10_MP_ImageTool_MacOS11 -set image /<Current_PATH>/flash_is.bin
